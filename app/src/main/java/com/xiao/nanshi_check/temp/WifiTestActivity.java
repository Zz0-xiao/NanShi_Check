...
import com.xiao.nanshi_check.activity.BaseActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.clean_Receiving://////////////////////////////////////////////
                ...
                break;
            case R.id.ONON0:
                edtSend.setText("ONON0");
                sendData();
//                printWriter.print("ONON0");
//                printWriter.flush();
                break;
            case R.id.ONONA:
                edtSend.setText("ONONA");
                sendData();
//                printWriter.print("ONONA");
//                printWriter.flush();
                break;
            case R.id.ONONF:
                edtSend.setText("ONONF");
                sendData();
//                printWriter.print("ONONF");
//                printWriter.flush();
                break;
            case R.id.ONONP:
                edtSend.setText("ONONP");
                sendData();
            ...
            public void run() {
                try {
                    ...
                    if (printWriter == null || context == null) {
                        Toast.makeText(WifiTestActivity.this, "连接失败!", Toast.LENGTH_SHORT).show();
//                        if (printWriter == null) {
